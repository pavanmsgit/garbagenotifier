      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextField(
            ...
            onSubmit: onSubmit,
            maxLength: maxLength,
            cursorColor: cursorColor ?? AppColor.dark,
            textColor: textColor ?? AppColor.dark,
            hintTextColor: hintTextColor ?? AppColor.dark,
            len: len,
            textSize: textSize,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextFormField(
        ...
        style: TextStyle(fontSize: textSize ?? 15, color: AppColor.dark,),
        obscureText: obscure,
